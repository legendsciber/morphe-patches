...
> **[v1.4.0](https://github.com/legendsciber/morphe-patches/releases/tag/v1.4.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;5 patches total
<details open>
...
| [Unlock All MCPE Versions](#unlock-all-mcpe-versions) | Desteklenen surum kontrolu her zaman gecer: liste disi Minecraft surumlerinde "not supported" ve 32/64-bit uyari ekrani cikmaz. |  |
