...
> **[v1.48.0](https://github.com/legendsciber/morphe-patches/releases/tag/v1.48.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;11 patches total
<details open>
...
| 💊&nbsp;Patch | 📜&nbsp;Description | ⚙️&nbsp;Options |
|----------|----------------|-----------|
| [Shadow Fight 2 IAP Bypass (Smali)](#shadow-fight-2-iap-bypass-smali) | Bypasses in-app purchases via smali patching. Triple interception: launchBillingFlow + zzbm callbacks. |  |
