...
val mctoolboxPremiumPatch = bytecodePatch(
    ...
    execute {
        SubscribeBypassFingerprint.method.addInstructions(0, """
            ...
            const/4 v13, 0x1
            invoke-virtual {v10, v13}, Ltc0;->d(Z)V
            const/4 v10, 0x0
            ...
            const-string v13, "Premium activated!"
            const/4 v14, 0x1
            invoke-static {v10, v13, v14}, Landroid/widget/Toast;->makeText(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;
            move-result-object v10
            ...
            const/4 v13, 0x4
            const/4 v14, 0x1
            invoke-direct {v10, v13, v14}, Landroid/view/KeyEvent;-><init>(II)V
