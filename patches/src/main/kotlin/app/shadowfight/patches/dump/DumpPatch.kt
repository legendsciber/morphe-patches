...
val sfDumpPatch = rawResourcePatch(
    ...
    execute {
        ...
        val soBytes = DumpSoBytes.part0() + DumpSoBytes.part1() + DumpSoBytes.part2() + DumpSoBytes.part3() + DumpSoBytes.part4() + DumpSoBytes.part5() + DumpSoBytes.part6() + DumpSoBytes.part7() + DumpSoBytes.part8() + DumpSoBytes.part9() + DumpSoBytes.part10() + DumpSoBytes.part11() + DumpSoBytes.part12()
